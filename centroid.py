...
def update(frame_number):
    ...
    # Desenhando o polígono usando o Convex Hull para os pontos dentro do campo
    if len(points) > 2:
    ...
    # Título atualizado para cada frame
